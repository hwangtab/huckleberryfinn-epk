    ...
    <section className="bg-hbf-white py-24 px-6">
      ...
      >
        ...
        <div className="space-y-6 text-lg text-hbf-charcoal-light leading-relaxed mb-12">
          <p>
            저희 역시 모든 것이 불확실했던 시절이 있었습니다. 그때의 저희처럼,
            지금도 자신만의 음악을 위해 고군분투하고 있을 신진 뮤지션들과
            연대하고자 합니다.
          </p>

          <p>
            이것은 심사나 경쟁이 아닌, 동료 뮤지션으로서 함께 무대를 만들고,
            저희가 겪어온 경험과 노하우를 나누는 약속입니다. 허클베리핀의 다음
            챕터를 함께 열어갈 아티스트를 기다립니다.
          </p>
        </div>
