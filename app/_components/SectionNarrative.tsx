      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <p>
                &quot;2집 &apos;나를 닮은 사내&apos;는 오랜 시간 &apos;아픈
                손가락&apos;이었습니다. 당시 저희가 가진 역량과 회사의 촉박한
                일정 속에서, 노래들이 가진 본연의 가능성을 온전히 피워내지
                못했다는 죄책감이 늘 마음 한편에 있었습니다. 평단의 좋은 평가와는
                별개로, 아티스트 스스로의 아쉬움은 선명했습니다.
              </p>

              <p>
                이번 재녹음은 단순한 추억의 재현이 아닙니다. 24년의 세월을 지나
                비로소 우리가 들려주고 싶었던 사운드와 편곡으로, 그 노래들에게
                마땅히 주었어야 할 완전한 생명을 불어넣는 과정입니다. 이것은
                과거에 대한 저희의 대답이자, 이 노래들을 사랑해주신 모든 분들께
                드리는 저희의 진심입니다.&quot;
              </p>
